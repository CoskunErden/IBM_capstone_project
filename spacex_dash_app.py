...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                ...
                marks={0: '0 kg', 2000: '2k', 4000: '4k', 6000: '6k', 8000: '8k', 10000: '10k'},
...
def update_scatter_chart(site_dropdown, payload_range):
    if site_dropdown == 'ALL':
        ...
        filtered_df = spacex_df[(spacex_df['Launch Site'] == site_dropdown) & (spacex_df['Payload Mass (kg)'] >= payload_range[0]) & (spacex_df['Payload Mass (kg)'] <= payload_range[1])]
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=f'Payload vs. Outcome for {site_dropdown}')

    fig.update_layout(xaxis_title='Payload Mass (kg)', yaxis_title='Class', legend_title='Booster Version')
    return fig
